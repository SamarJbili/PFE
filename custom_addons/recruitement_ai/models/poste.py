...
class Poste(models.Model):
    ...
    # Champ de texte pour les expériences particulières
    experiences_particulieres = fields.Text(string="Expériences particulières")


    # Champ pour le niveau de formation minimum requis
    ...
    # Champ pour les diplômes spécifiques (ex : "Diplôme en informatique", etc.)
    diplomes_specifiques = fields.Text(string="Diplômes spécifiques")